...
*.sw?`)
  ...
  async init () {
    ...
    this.masterName = await this.checkRemoteMaster()
    if (this.masterName) {
      await this.pullRemoteRepo(this.masterName, {
        '--allow-unrelated-histories': null,
      })
    } else {
      this.masterName = 'master'
      await this.pushRemoteRepo(this.masterName)
    }
  }
  ...
  async getRemote () {
    ...
    this.masterName = await this.checkRemoteMaster() || 'master'
